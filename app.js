...
server.listen(config.config.production.server_port2, function() {
    debug('Server running on ' + config.config.production.server_port2);
    ...
    // https.createServer(credentials, expressInstance).listen(config.production.server_port2, function () {
    //     debug('Server running on ' + config.production.server_port2);
